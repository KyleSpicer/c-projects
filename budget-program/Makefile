...
CC := gcc
# files
SRCS := budget-main.c budget-functions.c  # source files
OBJS := budget-main.o budget-functions.o  # object files created
# executables created
EXE := budget  # main executable
EXE_PROFILE := budget_profile  # profile executable
EXE_DEBUG := budget_debug  # debug executable
